...
abstract class AuthorizationCache
{
    ...
    /**
     * Returns the Value of the key if found in given config, or from Bitgo Config Manager
    ...
    {
        $config = ($config && is_array($config)) ? $config : BitgoConfigManager::getInstance()->getConfigHashmap();
