...
class ReflectionUtil
{
    ...
    {
        if ($class == get_class(new BitgoModel())) {
            // Make it generic if BitgoModel is used for generating this
            return get_class(new BitgoModel());
        }
        ...
        if (isset($param)) {
            ...
            throw new BitgoConfigurationException("Getter function for '$propertyName' in '$class' class should have a proper return type.");
        }
    }
