...
class BitgoHttpConnection
{
     ...
     */
    public function __construct(BitgoHttpConfig $httpConfig, array $config)
    {
        if (!function_exists("curl_init")) {
            throw new BitgoConfigurationException("Curl module is not available on this system");
        }
